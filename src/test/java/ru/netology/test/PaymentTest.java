...
import static org.postgresql.core.Oid.valueOf;
...
public class PaymentTest {
    ...
    void paymentCardNumber17numbers() {
        ...
        formPage.messageErrorNotification();
        assertEquals(number.substring(0, 16), FormPage.getValueAttribute(0));
    }
    ...
    @Test
    @DisplayName("19.Payment.Month.Cyrillic")
    ...
    @Test
    @DisplayName("20.Payment.Month.Latin")
    ...
    @Test
    @DisplayName("21.Payment.Month.Hieroglyph")
    ...
    @Test
    @DisplayName("22.Payment.Month.Char")
    ...
    @Test
    @DisplayName("23.Payment.Year.1 number")
    ...
    @Test
    @DisplayName("24.Payment.Year.3 number")
    ...
    @Test
    @DisplayName("25.Payment.Not exist year")
    ...
    @Test
    @DisplayName("26.Payment.Year.Cyrillic")
    ...
    @Test
    @DisplayName("27.Payment.Year.Latin")
    ...
    @Test
    @DisplayName("28.Payment.Year.Hieroglyph")
    ...
    @Test
    @DisplayName("29.Payment.Year.Char")
    ...
    @Test
    @DisplayName("30.Payment.CardholderName.Partial name")
    ...
    @Test
    @DisplayName("31.Payment.CardholderName.Numbers")
    ...
    @Test
    @DisplayName("32.Payment.CardholderName.Cyrillic")
    ...
    @Test
    @DisplayName("33.Payment.CardholderName.Char")
    ...
    @Test
    @DisplayName("34.Payment.CardholderName.Hieroglyph")
    ...
    @Test
    @DisplayName("35.Payment.CVC.2 number")
    ...
    @Test
    @DisplayName("36.Payment.CVC.4 number")
    ...
    @Test
    @DisplayName("37.Payment.CVC.Zero")
    void paymentCVCZero() {
    ...
    @Test
    @DisplayName("38.Payment.CVC.Char")
    void paymentCVCChar() {
    ...
    @Test
    @DisplayName("39.Payment.CVC.Hieroglyph")
    ...
    @Test
    @DisplayName("40.Payment.CVC.Latin")
    ...
    @Test
    @DisplayName("41.Payment.CVC.Cyrillic")
